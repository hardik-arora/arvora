...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function switchTab(tabId) {
    ...
    const allTabBtns = [tabBtnEngine, tabBtnRoutes, tabBtnGame, tabBtnPattern, tabBtnAnalytics, tabBtnScanner, tabBtnTravel, tabBtnTourism, tabBtnTrip, tabBtnDiscovery, tabBtnFestivals, tabBtnCompare, tabBtnBudget, tabBtnRouteSolver, tabBtnCulinary, tabBtnWeather];
    const allTabContents = [tabContentEngine, tabContentRoutes, tabContentGame, tabContentPattern, tabContentAnalytics, tabContentScanner, tabContentTravel, tabContentTourism, tabContentTrip, tabContentDiscovery, tabContentFestivals, tabContentCompare, tabContentBudget, tabContentRouteSolver, tabContentCulinary, tabContentWeather];
    const tabIds = ['engine', 'routes', 'game', 'pattern', 'analytics', 'scanner', 'travel', 'tourism', 'trip', 'discovery', 'festivals', 'compare', 'budget', 'routesolver', 'culinary', 'weather'];
    ...
    if (syncBtn) {
      syncBtn.addEventListener("click", () => {
        if (tripStops.length > 0) {
          ...
          weatherActiveCity = firstStop.toLowerCase();
          if (cityInput) cityInput.value = capitalizeWord(firstStop);
          ...
          renderChecklist();
          alert(`Synced! Loaded "${capitalizeWord(firstStop)}" as destination.`);
        } else {
